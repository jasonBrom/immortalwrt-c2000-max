...
const TICK_VALUES = [...Array.from({
  length: 21
}, (_, index) => index * 50), 1250, 1500, 1750, 2000, 2250, 2500, 2750, 3000];
...
function carrierFromText(text, fallback = "") {
  ...
  const carriers = ["中国移动", "中国联通", "中国电信", "中国广电", "移动", "联通", "电信", "广电", "China Mobile", "China Unicom", "China Telecom"];
...
function IconSpeed({
  ...
  return React.createElement("svg", {
    ...
    d: "M5.5 21.5a10.5 10.5 0 0 1 21 0",
    stroke: "currentColor",
    strokeWidth: "2.4",
    strokeLinecap: "round",
    opacity: "0.35"
  }), React.createElement("path", {
    d: "M5.5 21.5A10.5 10.5 0 0 1 21.8 12",
    stroke: "currentColor",
    strokeWidth: "2.4",
    strokeLinecap: "round"
...
function IconServer({
  ...
  return React.createElement("svg", {
    ...
    d: "M7.2 7.5h.01M7.2 16.5h.01M11 7.5h5.8M11 16.5h5.8",
    stroke: "currentColor",
    strokeWidth: "1.7",
    strokeLinecap: "round"
  }));
...
function IconEye({
  ...
  return React.createElement("svg", {
    ...
    d: "M3.8 12s2.9-5.2 8.2-5.2S20.2 12 20.2 12s-2.9 5.2-8.2 5.2S3.8 12 3.8 12Z",
    stroke: "currentColor",
    strokeWidth: "1.8",
    strokeLinecap: "round",
    strokeLinejoin: "round"
    ...
    stroke: "currentColor",
    strokeWidth: "1.8"
  }), hidden ? React.createElement("path", {
...
function IconLanguage({
  ...
  return React.createElement("svg", {
    ...
    d: "M4 5.5h9M8.5 3.8v1.7M11.7 5.5c-.9 2.8-2.6 5-5.6 6.6",
    stroke: "currentColor",
    strokeWidth: "1.8",
    strokeLinecap: "round",
    strokeLinejoin: "round"
  }), React.createElement("path", {
    d: "M5.3 7.9c1.2 2 2.8 3.4 5.2 4.5",
    stroke: "currentColor",
    strokeWidth: "1.8",
    strokeLinecap: "round",
    strokeLinejoin: "round"
  }), React.createElement("path", {
    d: "M14.2 19.5l3-8 3 8M15.3 16.6h3.8",
    stroke: "currentColor",
    strokeWidth: "1.8",
    strokeLinecap: "round",
    strokeLinejoin: "round"
...
function IconMoon({
  ...
  return React.createElement("svg", {
    ...
    d: "M20.2 14.4A7.6 7.6 0 0 1 9.6 3.8a8.3 8.3 0 1 0 10.6 10.6Z",
    stroke: "currentColor",
    strokeWidth: "1.8",
    strokeLinecap: "round",
    strokeLinejoin: "round"
...
function Surface({
  ...
  return React.createElement("div", {
    className: cn("rounded-[28px] border border-slate-200/80 bg-white shadow-sm", className)
  }, children);
}
function FilledButton({
  ...
  return React.createElement("button", _extends({
    className: cn("inline-flex h-12 items-center justify-center rounded-full bg-blue-600 px-6 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700 active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-60", className)
  }, props), children);
}
function MetricCard({
  label,
  ...
  return React.createElement(Surface, {
    ...
    className: "pb-1 text-sm font-medium text-slate-500"
...
function LanguageSwitch({
  ...
  return React.createElement("div", {
    ...
    className: "hidden h-10 w-10 place-items-center rounded-full text-slate-500 sm:grid"
  }, React.createElement(IconLanguage, {
    className: "h-5 w-5"
  })), items.map(item => React.createElement("button", {
    key: item.key,
    type: "button",
    onClick: () => setLocale(item.key),
    className: cn("h-10 rounded-full px-4 text-sm font-bold transition", locale === item.key ? "bg-white text-blue-700 shadow-sm" : "text-slate-500 hover:text-slate-800")
  }, item.label)));
}
...
function AboutModal({
  ...
  return React.createElement("div", {
    className: "fixed inset-0 z-50 flex items-end justify-center bg-slate-950/40 px-4 py-5 backdrop-blur-sm sm:items-center"
  }, React.createElement("div", {
    className: "cnspeed-about-modal w-full max-w-lg rounded-[28px] bg-white p-5 shadow-2xl sm:p-6",
    role: "dialog",
    "aria-modal": "true",
    "aria-label": t.about
  }, React.createElement("div", {
    className: "cnspeed-about-head flex items-start justify-between gap-4"
  }, React.createElement("div", null, React.createElement("div", {
    className: "cnspeed-about-title"
  }, t.about), React.createElement("div", {
    className: "cnspeed-about-subtitle"
  }, "CNSpeedTest")), React.createElement("button", {
    type: "button",
    onClick: onClose,
    ...
    className: "cnspeed-about-info"
  }, React.createElement("div", {
    className: "cnspeed-about-row"
  }, React.createElement("span", null, t.author), React.createElement("span", {
    className: "font-semibold text-slate-950"
  }, "inst")), React.createElement("div", {
    className: "cnspeed-about-row"
  }, React.createElement("span", null, t.version), React.createElement("span", {
    className: "cnspeed-about-value"
  }, appInfo.version || APP_VERSION)), React.createElement("div", {
    className: "cnspeed-about-row"
  }, React.createElement("span", null, t.platform), React.createElement("span", {
    className: "cnspeed-about-value"
  }, appInfo.platform || "desktop")), appInfo.machine_id ? React.createElement("div", {
    className: "cnspeed-about-row cnspeed-about-row-machine"
  }, React.createElement("span", null, t.machineId), React.createElement("span", {
    className: "cnspeed-machine-id"
  }, appInfo.machine_id)) : null), React.createElement("div", {
    className: "cnspeed-update-card"
  }, React.createElement("div", {
    className: "cnspeed-update-line"
  }, React.createElement("div", {
    className: "cnspeed-section-label"
  }, t.updateStatus), React.createElement("div", {
    className: "cnspeed-update-status"
  }, statusText || t.noVersionInfo)), React.createElement("button", {
    type: "button",
    onClick: onCheckUpdate,
    disabled: updateChecking,
    className: "cnspeed-check-button"
  }, updateChecking ? t.checkingUpdate : t.checkUpdate)), announcements.length > 0 ? React.createElement("div", {
    className: "cnspeed-about-section"
  }, React.createElement("div", {
    className: "cnspeed-section-label"
  }, t.announcements), React.createElement("div", {
    className: "cnspeed-about-announcements"
  }, announcements.slice(0, 3).map(item => React.createElement("div", {
    key: item.id || item.title,
    className: "cnspeed-about-announcement"
  }, React.createElement("div", {
    className: "cnspeed-about-announcement-title"
  }, item.title), item.body ? React.createElement("div", {
    className: "cnspeed-about-announcement-body"
  }, item.body) : null)))) : null, React.createElement(FilledButton, {
    type: "button",
    onClick: onClose,
    className: "cnspeed-about-done w-full"
  }, t.complete)));
}
function AnnouncementModal({
  ...
  return React.createElement("div", {
    ...
    role: "dialog",
    "aria-modal": "true",
    "aria-label": t.announcementPopupTitle
  }, React.createElement("div", {
    className: "flex items-start justify-between gap-4"
  }, React.createElement("div", null, React.createElement("div", {
    className: "text-lg font-bold text-slate-950"
  }, t.announcementPopupTitle), statusText ? React.createElement("div", {
    className: "mt-1 text-sm font-semibold text-blue-700"
  }, statusText) : null), React.createElement("button", {
    type: "button",
    onClick: onClose,
  ...
  }, announcements.length > 0 ? announcements.slice(0, 5).map(item => React.createElement("div", {
    key: item.id || item.title,
    className: "rounded-2xl bg-slate-50 px-4 py-3 text-sm"
  }, React.createElement("div", {
    className: "font-semibold text-slate-950"
  }, item.title), item.body ? React.createElement("div", {
    className: "mt-1 whitespace-pre-wrap text-slate-500"
  }, item.body) : null, item.download_url ? React.createElement("div", {
    className: "mt-2 truncate text-xs font-semibold text-blue-700"
  }, item.download_url) : null)) : React.createElement("div", {
    className: "rounded-2xl bg-slate-50 px-4 py-3 text-sm font-semibold text-slate-700"
  }, statusText)), React.createElement(FilledButton, {
    type: "button",
    onClick: onClose,
...
function Gauge({
  ...
  const theme = phase === "upload" ? {
    id: "uploadGaugeProgress",
    stops: ["#d8b4fe", "#a855f7", "#7e22ce"],
    text: t.upload,
    textColor: "#7e22ce"
  } : phase === "download" ? {
    id: "downloadGaugeProgress",
    stops: ["#93c5fd", "#3b82f6", "#1d4ed8"],
    text: t.download,
    textColor: "#2563eb"
  } : {
    id: "idleGaugeProgress",
    stops: ["#cbd5e1", "#94a3b8", "#64748b"],
    text: phase === "discover" ? "PING" : "",
    textColor: "#64748b"
  };
  const ticks = useMemo(() => {
  ...
  return React.createElement("div", {
    ...
    viewBox: "0 0 440 340",
    className: cn("cnspeed-gauge block w-full transition", phase === "download" || phase === "upload" || phase === "discover" ? "drop-shadow-sm" : ""),
    role: "img",
    "aria-label": t.speedGauge
    ...
    offset: "0",
    stopColor: theme.stops[0]
  }), React.createElement("stop", {
    offset: "0.48",
    stopColor: theme.stops[1]
  }), React.createElement("stop", {
    offset: "1",
    stopColor: theme.stops[2]
  }))), React.createElement("path", {
    className: "cnspeed-gauge-track",
    d: describeArc(centerX, centerY, radius, -115, 115),
    fill: "none",
    stroke: "currentColor",
    strokeWidth: "18",
    strokeLinecap: "round"
  }), speed > 1 ? React.createElement("path", {
    d: describeArc(centerX, centerY, radius, -115, currentAngle),
    fill: "none",
    stroke: `url(#${theme.id})`,
    strokeWidth: "18",
    strokeLinecap: "round"
  }) : null, phase === "discover" ? React.createElement("g", {
    opacity: "0.9"
  }, React.createElement("path", {
    d: describeArc(centerX, centerY, radius - 1, -115, 115),
    fill: "none",
    stroke: `url(#${theme.id})`,
    strokeWidth: "12",
    strokeLinecap: "round",
    strokeDasharray: "42 430"
  ...
  }))) : null, ticks.map(tick => React.createElement("line", {
    key: tick.index,
    className: tick.major ? "cnspeed-gauge-tick-major" : "cnspeed-gauge-tick",
    x1: tick.x1,
    y1: tick.y1,
    x2: tick.x2,
    y2: tick.y2,
    ...
    return React.createElement("text", {
      key: value,
      className: "cnspeed-gauge-tick-label",
      x: point.x,
      y: point.y + 5,
      textAnchor: "middle",
      fill: "currentColor",
  ...
  }), theme.text ? React.createElement("text", {
    x: centerX,
    y: "120",
    textAnchor: "middle",
    fill: "currentColor",
    className: cn("cnspeed-gauge-phase-label", phase === "upload" ? "cnspeed-gauge-upload" : phase === "download" ? "cnspeed-gauge-download" : "cnspeed-gauge-idle"),
    fontSize: "13",
    fontWeight: "700"
  }, theme.text) : null, React.createElement("text", {
    x: centerX,
    y: "190",
    textAnchor: "middle",
    fill: "currentColor",
    className: "cnspeed-gauge-value",
    fontSize: "46",
    fontWeight: "700"
  }, formatSpeed(speed)), React.createElement("text", {
    x: centerX,
    y: "220",
    textAnchor: "middle",
    fill: "currentColor",
    className: cn("cnspeed-gauge-unit", phase === "upload" ? "cnspeed-gauge-upload" : phase === "download" ? "cnspeed-gauge-download" : "cnspeed-gauge-idle"),
    fontSize: "17",
    fontWeight: "700"
  }, "Mbps")));
}
function ResultStatsCard({
  ...
  return React.createElement(Surface, {
    ...
    className: cn("text-sm font-bold", accentClass)
  ...
  }, formatSpeed(peakSpeed)), React.createElement("div", {
    className: "text-xs text-slate-500"
  }, "Mbps")), React.createElement("div", null, React.createElement("div", {
    className: "text-xs uppercase tracking-wide text-slate-500"
  }, t.avg), React.createElement("div", {
    className: "mt-1 text-xl font-semibold text-slate-950"
  }, formatSpeed(avgSpeed)), React.createElement("div", {
    className: "text-xs text-slate-500"
  }, "Mbps")), React.createElement("div", null, React.createElement("div", {
    className: "text-xs uppercase tracking-wide text-slate-500"
  }, t.used), React.createElement("div", {
    className: "mt-1 text-xl font-semibold text-slate-950"
  }, formatDataFromBytes(usedBytes, locale)), React.createElement("div", {
    className: "text-xs text-slate-500"
  }, t.traffic))));
}
function ErrorBanner({
  ...
  return React.createElement("div", {
    className: "mt-5 rounded-[24px] border border-red-200 bg-red-50 px-5 py-4 text-red-800 shadow-sm"
  }, React.createElement("div", {
    className: "text-sm font-bold"
  }, t.errorTitle), React.createElement("div", {
    className: "mt-1 break-words text-sm font-medium"
  }, message), React.createElement("div", {
    className: "mt-1 text-xs text-red-700/80"
  }, t.errorHint));
}
...
function NodeSettingsModal({
  ...
  const visibleNodes = useMemo(() => {
    if (!nodeQuery) return availableNodes.map((node, index) => ({
      node,
      index
    }));
    return availableNodes.map((node, index) => ({
      ...
      const text = [node.name, node.host, node.port, node.hostid, node.province, node.city, node.operator].filter(Boolean).join(" ").toLowerCase();
      return text.includes(nodeQuery);
    });
  }, [availableNodes, nodeQuery]);
  const countText = nodeQuery ? (t.nodeSearchCount || "{shown} / {total}").replace("{shown}", visibleNodes.length).replace("{total}", availableNodes.length) : (t.nodeCount || "{count}").replace("{count}", availableNodes.length);
  if (!open) return null;
  return React.createElement("div", {
    className: "fixed inset-0 z-50 flex items-end justify-center bg-slate-950/40 px-4 py-5 backdrop-blur-sm sm:items-center"
  }, React.createElement("div", {
    ...
    role: "dialog",
    "aria-modal": "true",
    "aria-label": t.nodeSettings
  }, React.createElement("div", {
    className: "flex items-start justify-between gap-4"
  }, React.createElement("div", null, React.createElement("div", {
    className: "text-lg font-bold text-slate-950"
  }, t.nodeSettings), React.createElement("div", {
    className: "mt-1 text-sm text-slate-500"
  }, t.nodeMode)), React.createElement("button", {
    type: "button",
    onClick: onClose,
    className: "grid h-10 w-10 shrink-0 place-items-center rounded-full bg-slate-100 text-xl font-semibold leading-none text-slate-500 transition hover:bg-slate-200 hover:text-slate-800",
    "aria-label": t.complete,
    ...
    className: "mt-5 grid grid-cols-2 gap-2 rounded-full bg-slate-100 p-1"
  ...
  }, t.autoNode), React.createElement("button", {
    type: "button",
    onClick: () => {
      setNodeMode("manual");
  ...
  }, t.manualNode)), React.createElement("div", {
    className: "mt-5"
  }, React.createElement("div", {
  ...
  }, nodesLoading ? t.loadingNodes : t.loadNodes)), React.createElement("div", {
    className: "mt-2 text-xs font-semibold text-slate-400"
  }, countText), React.createElement("div", {
    className: "mt-4 max-h-[42vh] overflow-y-auto pr-1"
  }, visibleNodes.length > 0 ? React.createElement("div", {
    ...
    className: cn("min-h-11 rounded-2xl px-4 py-2 text-left text-sm font-semibold transition", selectedNodeIndex === index && nodeMode === "manual" ? "bg-blue-600 text-white" : "bg-slate-50 text-slate-700 hover:bg-slate-100")
  }, React.createElement("span", {
    className: "flex items-center gap-2"
  }, React.createElement("span", {
    className: "block min-w-0 flex-1 break-words"
  }, node.name), node.recommended ? React.createElement("span", {
    className: cn("shrink-0 rounded-full px-2 py-0.5 text-[11px] font-bold", selectedNodeIndex === index && nodeMode === "manual" ? "bg-white/20 text-white" : "bg-blue-50 text-blue-700")
  }, t.recommendedNode) : null), React.createElement("span", {
    className: cn("mt-1 block truncate text-xs font-medium", selectedNodeIndex === index && nodeMode === "manual" ? "text-blue-100" : "text-slate-400")
  }, [node.province, node.city, node.operator].filter(Boolean).join(" · ") || `${node.host}:${node.port}`)))) : React.createElement("div", {
    className: "rounded-2xl bg-slate-50 px-4 py-6 text-center text-sm font-medium text-slate-500"
  }, nodesLoading ? t.loadingNodes : t.noNodes))), React.createElement(FilledButton, {
    type: "button",
    onClick: onClose,
    className: "mt-5 w-full"
  }, t.complete)));
...
function UserInfoCard({
  ...
  }, React.createElement(IconMapPin, {
    className: "h-7 w-7"
  })), React.createElement("div", {
  ...
  }, t.userInfo), React.createElement("div", {
    className: "flex shrink-0 items-center gap-2"
  }, React.createElement("span", {
    className: "cnspeed-network-badge",
    title: t.networkType
  }, networkLabel), React.createElement(PrivacyButton, {
  ...
  }, t.userIp), React.createElement("span", {
    className: "truncate font-semibold text-slate-950"
  }, privacyHidden && !hasError ? maskText(ip, 8) : ip)), React.createElement("div", {
    className: "flex items-center justify-between gap-3"
  }, React.createElement("span", {
    className: "text-slate-500"
  }, t.region), React.createElement("span", {
    className: "truncate font-semibold text-slate-950"
  }, privacyHidden && !hasError ? maskText(location, 4) : location)), React.createElement("div", {
    className: "flex items-center justify-between gap-3"
  }, React.createElement("span", {
    className: "text-slate-500"
  }, t.carrier), React.createElement("span", {
    className: "truncate font-semibold text-slate-950"
  }, carrier))))));
}
function SpeedChart({
  ...
  return React.createElement(Surface, {
  ...
  }, phaseLabel)), React.createElement("div", {
    className: cn("rounded-full px-3 py-1 text-xs font-semibold", active ? "bg-slate-100 text-slate-700" : "bg-slate-50 text-slate-400")
  }, active ? t.live : t.idle)), React.createElement("div", {
  ...
  }), displayPoints.length > 0 ? React.createElement(React.Fragment, null, React.createElement("path", {
    d: areaPath,
    fill: "currentColor",
    className: cn("opacity-10", accent)
  }), React.createElement("path", {
    d: linePath,
    fill: "none",
    stroke: "currentColor",
    ...
    fontSize: "14",
    fontWeight: "600"
  }, t.noDataYet))), React.createElement("div", {
    className: "mt-4 grid grid-cols-3 gap-3"
  }, React.createElement("div", null, React.createElement("div", {
    className: "text-xs uppercase tracking-wide text-slate-500"
  }, t.max), React.createElement("div", {
    className: "mt-1 text-lg font-semibold text-slate-950"
  }, formatSpeed(stats.peak)), React.createElement("div", {
    className: "text-xs text-slate-500"
  }, "Mbps")), React.createElement("div", null, React.createElement("div", {
    className: "text-xs uppercase tracking-wide text-slate-500"
  }, t.avg), React.createElement("div", {
    className: "mt-1 text-lg font-semibold text-slate-950"
  }, formatSpeed(stats.avg)), React.createElement("div", {
    className: "text-xs text-slate-500"
  }, "Mbps")), React.createElement("div", null, React.createElement("div", {
    className: "text-xs uppercase tracking-wide text-slate-500"
  }, t.used), React.createElement("div", {
    className: "mt-1 text-lg font-semibold text-slate-950"
  }, formatDataFromBytes(stats.bytes, locale)), React.createElement("div", {
    className: "text-xs text-slate-500"
  }, t.traffic))));
}
function SpeedtestPage() {
  ...
  const liveSpeed = running && Number(summary.live_mbps) ? Number(summary.live_mbps) : phase === "upload" ? uploadStats.avg : phase === "download" ? downloadStats.avg : job?.status === "done" ? downloadStats.avg || uploadStats.avg : 0;
  const ping = Number(summary.latency_avg_ms) || 0;
  const jitter = summary.latency_max_ms != null && summary.latency_min_ms != null ? Math.max(0, Number(summary.latency_max_ms) - Number(summary.latency_min_ms)) : 0;
  ...
  const phaseTitle = phase === "download" ? t.downloading : phase === "upload" ? t.uploading : phase === "cancelled" ? job?.status === "cancelled" ? t.cancelled : t.stopping : phase === "discover" ? t.discovering : phase === "error" ? t.failed : job?.status === "done" ? t.resultReady : t.readyToStart;
  ...
  async function loadAppInfoAndCheck() {
    ...
    try {
      info = {
        ...DEFAULT_APP_INFO,
        ...(await fetchJSONWithTimeout("/api/app-info", {}, 3000))
      };
      setAppInfo(info);
    } catch (err) {
  ...
  async function submitReport(doneJob) {
    ...
    const payload = {
      ...
      speedtest: {
        ...
        jitter_ms: doneSummary.latency_max_ms != null && doneSummary.latency_min_ms != null ? Math.max(0, Number(doneSummary.latency_max_ms) - Number(doneSummary.latency_min_ms)) : 0,
    ...
    try {
      const data = await fetchJSONWithTimeout("/api/report", {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
  ...
  return React.createElement("main", {
    ...
    className: "flex flex-col gap-4 rounded-[30px] border border-slate-200/80 bg-white px-4 py-4 shadow-sm sm:flex-row sm:items-center sm:justify-between sm:px-6"
  }, React.createElement("div", {
    className: "flex items-center gap-3 text-left"
  }, React.createElement("div", {
    className: "grid h-12 w-12 place-items-center rounded-2xl bg-blue-50 text-blue-700"
  }, React.createElement(IconSpeed, {
    className: "h-8 w-8"
  })), React.createElement("div", null, React.createElement("div", {
    className: "text-lg font-bold tracking-tight sm:text-xl"
  }, t.appTitle), React.createElement("div", {
    className: "text-sm text-slate-500"
  }, t.appSubtitle))), React.createElement("div", {
  ...
  }, t.about), appInfo.platform !== "openwrt" ? React.createElement("button", {
    type: "button",
    onClick: shutdownApp,
    className: "h-10 rounded-full bg-red-50 px-4 text-sm font-bold text-red-700 transition hover:bg-slate-100"
  }, t.exitApp) : null)), React.createElement("div", {
    className: "cnspeed-router-notice",
    role: "note"
  }, t.routerSpeedNotice), React.createElement("section", {
    className: "mt-5 grid grid-cols-2 gap-4 lg:grid-cols-4"
  }, React.createElement(MetricCard, {
    label: t.ping,
    value: ping ? ping.toFixed(1) : "--",
    unit: "ms",
    helper: t.roundTripLatency
  }), React.createElement(MetricCard, {
    label: t.jitter,
    value: jitter ? jitter.toFixed(1) : "--",
    unit: "ms",
    helper: t.latencyVariation
  }), React.createElement(MetricCard, {
    label: t.totalData,
    value: formatDataFromBytes(totalBytes, locale),
    unit: "",
    helper: t.totalTrafficHelper
  }), React.createElement(MetricCard, {
    label: t.quality,
    value: quality,
    unit: "",
    helper: errorMessage || t.overallEvaluation
  })), React.createElement(ErrorBanner, {
    message: errorMessage,
    t: t
  }), React.createElement("section", {
    className: "mt-5 grid gap-5 lg:grid-cols-[minmax(0,1.45fr)_minmax(320px,0.75fr)]"
  }, React.createElement(Surface, {
    className: "cnspeed-phase-card p-5 sm:p-7"
  }, React.createElement("div", {
    className: "flex flex-col items-center"
  }, React.createElement("div", {
    className: "mb-3 flex w-full flex-wrap items-center justify-between gap-3"
  }, React.createElement("div", null, React.createElement("div", {
    className: "text-sm font-semibold text-slate-500"
  }, t.currentPhase), React.createElement("div", {
    className: "mt-1 text-2xl font-bold tracking-tight text-slate-950"
  }, phaseTitle)), React.createElement("div", {
    className: cn("rounded-full px-4 py-2 text-sm font-bold", phase === "upload" ? "bg-purple-50 text-purple-700" : phase === "download" ? "bg-blue-50 text-blue-700" : phase === "error" ? "bg-red-50 text-red-700" : "bg-emerald-50 text-emerald-700")
  }, phaseBadge)), React.createElement(Gauge, {
    speed: displaySpeed,
    phase: phase,
    t: t
  }), React.createElement("div", {
    className: "mt-1 flex flex-wrap items-center justify-center gap-3"
  }, React.createElement(FilledButton, {
    type: "button",
    onClick: startTest,
    disabled: running
  }, running ? t.testing : job?.status === "done" || job?.status === "error" || job?.status === "cancelled" ? t.restartTest : t.startTest), running ? React.createElement("button", {
    type: "button",
    onClick: cancelTest,
  ...
  }, job?.status === "cancelling" ? t.stopping : t.stopTest) : null)), reportId ? React.createElement("div", {
    className: "cnspeed-report-id"
  }, reportId) : null), React.createElement("aside", {
    className: "space-y-4"
  }, React.createElement(ResultStatsCard, {
    title: t.downloadResult,
    accentClass: "text-blue-700",
    peakSpeed: downloadStats.peak,
    avgSpeed: downloadStats.avg,
    usedBytes: downloadStats.bytes,
    t: t,
    locale: locale
  }), React.createElement(ResultStatsCard, {
    title: t.uploadResult,
    accentClass: "text-purple-700",
    peakSpeed: uploadStats.peak,
    avgSpeed: uploadStats.avg,
    usedBytes: uploadStats.bytes,
    t: t,
    locale: locale
  }), React.createElement(Surface, {
    className: "p-5"
    ...
    className: "grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-blue-50 text-blue-700"
  }, React.createElement(IconServer, {
    className: "h-7 w-7"
  })), React.createElement("div", {
    className: "min-w-0 flex-1"
  }, React.createElement("div", {
    ...
    className: "text-sm font-medium text-slate-500"
  }, t.server), React.createElement("div", {
    className: "flex shrink-0 items-center gap-2"
  }, React.createElement("button", {
    type: "button",
  ...
  }, t.nodeSettings), React.createElement(PrivacyButton, {
    hidden: privacyHidden,
    onToggle: togglePrivacy,
    t: t
  }))), React.createElement("div", {
    className: "mt-1 truncate text-lg font-semibold text-slate-950"
  }, visibleNodeName)))), React.createElement(UserInfoCard, {
    ipInfo: ipInfo,
    networkType: networkType || t.unknown,
    t: t,
    privacyHidden: privacyHidden,
    onTogglePrivacy: togglePrivacy
  }))), React.createElement("section", {
    className: "mt-5 grid gap-5 lg:grid-cols-2"
  }, React.createElement(SpeedChart, {
    title: t.downloadCurve,
    accent: "text-blue-600",
    points: downloadSeries,
    active: phase === "download",
    phaseLabel: t.downloadCurveDesc,
    stats: downloadStats,
    t: t,
    locale: locale
  }), React.createElement(SpeedChart, {
    ...
    points: uploadSeries,
    active: phase === "upload",
    phaseLabel: t.uploadCurveDesc,
    stats: uploadStats,
    t: t,
    locale: locale
  }))), React.createElement(NodeSettingsModal, {
...
ReactDOM.createRoot(document.getElementById("root")).render(React.createElement(SpeedtestPage, null));
