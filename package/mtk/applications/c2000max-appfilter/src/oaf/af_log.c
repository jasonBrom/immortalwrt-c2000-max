...
/*
 * C2000MAX recognition profiles:
 *   seamless: hold_acceleration=0, max_dpi_packets=8
 *   balanced: hold_acceleration=1, max_dpi_packets=8
 *   precise:  hold_acceleration=1, max_dpi_packets=64
 */
int g_hold_acceleration __read_mostly = 0;
int g_max_dpi_packets __read_mostly = DEFAULT_DPI_PKT_NUM;
static int oaf_zero;
static int oaf_one = 1;
static int oaf_max_dpi_packets = MAX_DPI_PKT_NUM;
/*
...
static struct ctl_table oaf_table[] = {
	...
	{
		.procname	= "hold_acceleration",
		.data		= &g_hold_acceleration,
		.maxlen 	= sizeof(int),
		.mode		= 0644,
	...
	{
		.procname	= "max_dpi_packets",
		.data		= &g_max_dpi_packets,
		.maxlen 	= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= &oaf_one,
		.extra2		= &oaf_max_dpi_packets,
	},
