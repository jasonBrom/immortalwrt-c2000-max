...
extern unsigned int g_feature_reload_attempt;
extern unsigned int g_feature_reload_loaded;
extern int g_feature_reload_errno;
extern int g_user_mode;
extern int g_disable_quic;
extern int g_app_filter_mode;
extern int g_hold_acceleration;
extern int g_max_dpi_packets;
